          ...
          <tbody>
            {order.map((o, index) => (
              <tr key={o._id}>
                ...
                <td>
                  {(o.item.price && !o.paid) && <label onClick={()=>setDeletingOrder(o)} for="delete-confirm-modal" className="btn btn-xs btn-error modal-button text-white"> Cancel</label>}
            ...
            {
              deletingOrder && <DeleteConfirmModal deletingOrder={deletingOrder} setDeletingOrder={setDeletingOrder} handleDelete={handleDelete}></DeleteConfirmModal>
            }
    </div>
  );
};
